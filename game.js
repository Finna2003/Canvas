...
function Box(options) {
    this.x = options.x || canvas.width / 60;
    this.y = options.y || canvas.width / 60;
    this.width = options.width || canvas.width / 15;
    this.height = options.height || canvas.height / 5;
    this.color = options.color || '#4B0082';
...
function displayScore1() {
    ctx.font = "20px Arial";
    ctx.fillStyle = "rgb(255,255,)";
    var str1 = score1;
    ctx.fillText(str1, (canvas.width/2) - canvas.width/3.5, canvas.height/15);
}
...
function displayScore2() {
    ...
    ctx.fillStyle = "rgb(255,255,)";
    var str2 = score2;
    ctx.fillText(str2, (canvas.width / 2) + canvas.width/3.5, canvas.height/15);
}
